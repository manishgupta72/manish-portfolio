export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1oIe3xOePKU2OVywLzyyXj51R6x2If0Sk/view?usp=drive_link",
    ...
    skills: [
      {
        name: "Laravel",
        image:
          "https://cdn.iconscout.com/icon/free/png-256/free-laravel-logo-icon-download-in-svg-png-gif-file-formats--wordmark-programming-langugae-freebies-pack-logos-icons-1175147.png?f=webp&w=256",
      },
      {
        name: "Php",
        image:
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Linux",
        image:
          "https://cdn.pixabay.com/photo/2017/01/31/15/33/linux-2025130_1280.png",
      },
      {
        name: "Docker",
        image:
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Cpanel",
        image:
          "https://user-images.githubusercontent.com/13507838/87209562-b26e5d80-c2e8-11ea-8af0-bdb147d0d778.png",
      },
      {
        name: "Figma",
        image:
...
export const experiences = [
  {
    id: 0,
    img: "https://rbtech.in/assets/images/logo.png",
    role: "Junior Developer",
    company: "RB Tech Solutions LLC",
...
export const education = [
  {
    id: 0,
    img: "https://www.lalacollege.edu.in/assets/FrontendAssessts/img/logo_footer.png",
    school: "Lala Lajpatrai College of Commerce And Economics",
    date: "June 2021 - May 2024",
    grade: "9.2 CGPA",
    desc: "I am currently pursuing a Bachelor of Information Technolody at Lala Lajpatrai College of Commerce And Economics, Mumbai. I have completed 4 semesters and have a CGPA of 9.2. I have taken courses in Data Structures, Algorithms, Object-Oriented Programming, Database Management Systems, Operating Systems, and Computer Networks, among others. I am also a member of the Advance Certificate in Software Engineering, where I am learning and working on exciting projects with a team of talented developers.",
    degree:
      "Bachelor of Information Technology - BscIT, Computer Science and Engineering",
  },
];
...
export const projects = [
  {
    id: 9,
    title: "Apeksha Films & Music",
    date: "",
    description:
      "🚀 Successfully launched a sleek **CRM Admin Dashboard** and **Frontend Website** for **Apeksha Films** with **20% faster response time**, **best-in-class UI**, **downloadable reports**, and seamless CRM functionality management! 🎉📊✨",
    image:
      "https://i.pinimg.com/736x/1b/db/65/1bdb655091ef4d03a8c51cc10177ba1f.jpg",
    tags: ["Html", "Css", "Java Script","Bootstrap", "Php", "Ajax"],
    category: "Website & CRM",
    github: "#",
    webapp: "https://apekshafilms.com/",
    member: [
      {
        name: "Manish Gupta",
  ...
  {
    id: 12,
    title: "Desi Tadka Music",
    date: "",
    description:
      "🎵 Successfully delivered a stunning CRM Admin Dashboard and Frontend Website for Desitadka Music with enhanced performance, intuitive UI, seamless music management, and downloadable analytics reports! 🚀🎶📊✨",
    image:
      "https://i.pinimg.com/736x/09/be/af/09beaf6e3293fb8d56f762965a7be342.jpg",
    tags: ["Html", "Css", "Java Script", "Bootstrap", "Php", "Ajax"],
    category: "Website & CRM",
    github: "#",
    webapp: "https://desitadkamusic.com/",
    member: [
      {
        name: "Manish Gupta",
        img: "https://avatars.githubusercontent.com/u/69005837?v=4",
  ...
  },
  {
    ...
    date: "",
    description:
      "🔹 Team HR A cutting-edge CRM system with features like role management (Admin, Operation, Recruiter), employee records management, and seamless blogs and slugs management. Designed with an intuitive UI, this solution streamlines team operations, boosts productivity, and ensures effective data handling. 🚀👩‍💻📊✨",
    image:
      "https://i.pinimg.com/736x/d6/66/5a/d6665a1c372dfe401e1533299a21bb88.jpg",
      tags: [
        "Html",
        "Css",
        "Java Script",
  ...
  },
  {
    ...
    date: "",
    description:
      "🔹 Tactics A versatile CRM system offering advanced role management, employee performance tracking, and real-time reporting. Equipped with a user-friendly interface, it enhances collaboration, ensures efficient workflow management, and delivers actionable insights. 🚀👨‍💻📈✨",
    image:
      "https://i.pinimg.com/736x/4d/12/6f/4d126f6c3a7533b7993fac3bfe33ffbf.jpg",
    tags: [
      "Laravel",
      "Html",
      "Css",
  ...
  },
  {
    ...
    date: "",
    description:
      "🔹 Cibil CRM A powerful system designed to streamline credit score management, integrate customer queries, and automate data-driven insights. Built with a modern UI, it optimizes operations and supports informed decision-making. 💳📊🚀✨",
    image:
      "https://i.pinimg.com/736x/4f/ea/98/4fea98344ddf8d0635c9463da5cf9b37.jpg",
    tags: [
      "Html",
      "Css",
      "Java Script",
